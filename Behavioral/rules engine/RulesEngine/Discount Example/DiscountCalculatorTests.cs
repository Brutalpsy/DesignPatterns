...
namespace RulesEngine
{
    public class Tests
    {
        ...
        {
            var customer = CreateCustomer(DEFAULT_AGE, firstPurchaseDate: DateTime.Today.AddDays(-1));
        ...
        {
            var customer = CreateCustomer(65, firstPurchaseDate: DateTime.Today.AddDays(-1));
        ...
        {
            var customer = CreateCustomer(customerAge, firstPurchaseDate: DateTime.Today.AddDays(-1));
        ...
        public void ReturnsCorrectLoyaltyDiscountForLongtimeCustomers(int yearsAsCustomer, decimal expectedDiscount)
        {
            var customer = CreateCustomer(DEFAULT_AGE,
                firstPurchaseDate: DateTime.Today.AddYears(-yearsAsCustomer).AddDays(-1));
        ...
        {
            var customer = CreateBirthdayCustomer(DEFAULT_AGE, firstPurchaseDate: DateTime.Today.AddYears(-yearsAsCustomer).AddDays(-1));
        ...
        {
            var customer = CreateBirthdayCustomer(20, firstPurchaseDate: DateTime.Today.AddDays(-1));
